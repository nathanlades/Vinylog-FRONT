...
public class ArtistaResenaAdapter extends RecyclerView.Adapter<ArtistaResenaAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public ArtistaResenaAdapter(Context context, List<Resena> resenas, List<Perfil> perfiles, String imagen) {
